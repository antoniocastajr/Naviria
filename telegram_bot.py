...
# DESCRIPTION OF THE FILE: This file deploys all TELEGRAM's functions required for this project.
...
async def respond(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    ''' Deploys Naviria, connecting the user with the agent'''

    try:
        response = await set_model(update.message.text, update.effective_user.id)  
